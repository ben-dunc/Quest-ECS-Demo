...
public partial struct SimpleECSSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        var job = new BobJob
        {
            frequency = SimpleECSManager.Instance.bobFrequency,
            magnitude = SimpleECSManager.Instance.bobMagnitude,
    ...
    void UpdateToEntityCount(ref SystemState state, ref EntityCommandBuffer ecb)
    {
    }
